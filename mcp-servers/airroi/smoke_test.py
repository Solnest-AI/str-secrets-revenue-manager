"""Quick AirROI MCP smoke test: health_check + a public-example comparables + estimate pull."""
import airroi_client as ar

print("health_check:", ar.health_check())

comps = ar.get_comparables(address="4599 Chateau Blvd, Whistler, BC, Canada",
...
est = ar.get_estimate(address="4599 Chateau Blvd, Whistler, BC, Canada",
